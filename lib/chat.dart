...
class _ChatState extends State<Chat> {
  ...
  void handleSubmitted(text) async {
    ...
    if (string1.toLowerCase().contains(string2.toLowerCase())) {
      ...
      String final_mail = temp_mail+"?subject=This is Subject Title&body="+mail_body;
      print(final_mail);
      //final_mail = "schulershub@gmail.com?subject=This is Subject Title&body= gh";
      launch(final_mail);
      trimmed = "";
    }
    else{
...
//url saver
//https://www.google.co.in/search?q=hy
